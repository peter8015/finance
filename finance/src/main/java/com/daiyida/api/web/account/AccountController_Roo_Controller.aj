...
privileged aspect AccountController_Roo_Controller {
    ...
    @Autowired
    RoleService AccountController.roleService;
    ...
    public String AccountController.show(@PathVariable("id") String id, Model uiModel) {
    ...
    public String AccountController.updateForm(@PathVariable("id") String id, Model uiModel) {
        populateEditForm(uiModel, accountService.findAccount(id));
        return "accounts/update";
    }
    
    @RequestMapping(value = "/{id}", method = RequestMethod.DELETE, produces = "text/html")
    public String AccountController.delete(@PathVariable("id") String id, @RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
    ...
    void AccountController.addDateTimeFormatPatterns(Model uiModel) {
        uiModel.addAttribute("account_createtime_date_format", DateTimeFormat.patternForStyle("M-", LocaleContextHolder.getLocale()));
    }
