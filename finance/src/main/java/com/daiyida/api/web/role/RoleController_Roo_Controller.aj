...
privileged aspect RoleController_Roo_Controller {
    ...
    public String RoleController.create(@Valid Role role, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
        ...
        return "redirect:/role/" + encodeUrlPathSegment(role.getId().toString(), httpServletRequest);
    }
    ...
    public String RoleController.show(@PathVariable("id") String id, Model uiModel) {
    ...
    public String RoleController.updateForm(@PathVariable("id") String id, Model uiModel) {
        populateEditForm(uiModel, roleService.findRole(id));
        return "role/update";
    }
    
    @RequestMapping(value = "/{id}", method = RequestMethod.DELETE, produces = "text/html")
    public String RoleController.delete(@PathVariable("id") String id, @RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
